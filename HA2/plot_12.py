...
filename2 = '9_converge_cutoff_CO.txt' # '2_converge_cutoff_energy_bulk.txt'
...
ax_cutoff.set_ylabel('Simulated energy [eV]')
...
plt.show()
# fig.savefig('converge_bulk.png', bbox_inches='tight')
